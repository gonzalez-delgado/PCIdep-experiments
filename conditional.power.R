...
# Appendix C, producing Figure C.1.
...
# Conditional power: oracle (Figure C.1, panels (a-c))
...
# Conditional power: Sigma over-estimation (Figure C.1, panels (d-f))
...
# Power loss in estimation (Figure C.1, panels (g-i))
